            ...
            <form:form cssClass="form-horizontal" modelAttribute="elementVO" action="/admin/element/add" method="POST">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <form:textarea path="newElements" rows="3" class="form-control" id="inputNewElements" placeholder="Element Type" />
        ...
        <%--            ALERTS--%>
            <div class="${successAlert == null ? 'hidden' : successAlert}" id="successAlert">
                <div class="alert alert-dismissible alert-success">
                    ...
                    <strong>Element added</strong> successfully <a href="#" class="alert-link">to the database.</a>.
                </div>
            </div>
            <%--WARNING ALERT--%>
            <div class="${warningAlert == null ? 'hidden' : warninglert }" id="warningAlert">
                <div class="alert alert-dismissible alert-warning">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <h4>WARNING!</h4>
                    <strong>All fields required!</strong><a href="#" class="alert-link"></a>.
                </div>
            </div>
            <%--ERROR ALERT--%>
